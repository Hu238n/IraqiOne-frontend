<template>
  <div class="container text-white mx-auto">
    <h1 class="text-2xl mt-20">اضافة بيانات</h1>
    <div>
      <div class="mt-2">
      ...
      <div>
        <v-datepicker v-if="form.Type == 2" v-model="form.Dok" label="تاريخ الخطف"></v-datepicker>
      </div>
      <div>
        <v-datepicker v-if="form.Type == 3" v-model="form.Dok" label="تاريخ الاصابة"></v-datepicker>
      </div>
      <div class="mt-2">
...
export default {
  ...
  head() {
    return {
      title: 'اضافة بيانات - ثورة تشرين',
      meta: [{ hid: 'description', name: 'description', content: 'اضف بيانات المفقودين او الشهداء او المحطوفية في احداث ثورة تشرين' }]
    }
  },
